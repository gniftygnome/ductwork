...
public class DamperScreenHandler extends ScreenHandler {
    private final Inventory inventory;

    public DamperScreenHandler(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, new SimpleInventory(1));
    }

    public DamperScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory) {
